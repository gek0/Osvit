...
class AdminController extends BaseController
{
    ...
    public function updateAboutUs()
    {
        ...
        return Redirect::to('admin/naslovnica')->with(['success' => 'Sekcija "O nama" je uspješno izmjenjena']);
    }
    ...
    public function updateFunFacts()
    {
        ...
        return Redirect::to('admin/naslovnica')->with(['success' => 'Sekcija "Info brojevi" je uspješno izmjenjena']);
    }
