...
class AthleteController extends BaseController
{
    ...
    public function showAthletes()
    {
        ...
        return View::make('admin.athletes')->with(['page_title' => 'Administracija',
    ...
    {
        if($id == null){
            return Redirect::to(route('admin-athletes'))->withErrors('Sportaš ne postoji');
        }
        else{
            ...
            if(!$athlete){
                ...
                return View::make('admin.athletes-edit')->with(['page_title' => 'Administracija',
                                                                'athlete' => $athlete
                ]);
            }
        }
    ...
    public function updateAthlete()
    {
        ...
        return Redirect::to(route('admin-athletes'))->with(['success' => 'Sportaš je uspješno izmjenjen']);
    }
    ...
    public function addAthlete()
    {
        ...
        return Redirect::to(route('admin-athletes'))->with(['success' => 'Sportaš je uspješno dodan']);
    }
        ...
        if($id == null){
            ...
            if(!$athlete){
                ...
                try{
                    ...
                    return Redirect::to(route('admin-athletes'))->withErrors('Sportaš i slika sportaša nisu mogli biti obrisani');
                }

                return Redirect::to(route('admin-athletes'))->with(['success' => 'Sportaš je uspješno obrisan']);
            }
        }
    }
}