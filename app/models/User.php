...
class User extends Eloquent implements UserInterface, RemindableInterface {
	...
	public static $messages = ['email.required' => 'E-mail adresa je obavezna.',
		...
		'email.between' => 'E-mail adresa mora biti kraæa od 50 znakova.',
		'email.unique' => 'Unjeta e-mail adresa se veæ koristi.',
		'username.required' => 'Korisnièko ime je obavezno.',
		'username.alpha_num' => 'Korisnièko ime se može sastojati samo od slova i brojeva.',
		'username.between' => 'Korisnièko ime mora biti duljine od 3 do 20 znakova.',
		'username.unique' => 'Korisnièko ime se veæ koristi.',
